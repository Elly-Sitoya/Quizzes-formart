...
// owns, e.g.:
//
//   <Route path="/quizzes/matching-pairs/*" element={<MatchingPairsModule />} />
//
...
// quiz data lives behind QuizzesProvider, so swapping local storage for a
// real API later only means changing the inside of that provider, never
// any of the screens below.
export default function MatchingPairsModule() {
  return (
    <QuizzesProvider>
      <div className="app">
        <Routes>
