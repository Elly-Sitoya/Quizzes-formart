...
import './DictationManager.css';

// The actual content of the "Dictation" question type inside the quiz
// builder modal: create a new dictation quiz, then rename, delete, or
// jump into editing the sentences of any existing one.
export default function DictationManager() {
  ...
  return (
    <div className="dictation-manager">
