...
import './WordScrambleManager.css';

// The actual content of the "Word Scramble Puzzle" question type inside the
// quiz builder modal: create a new quiz, then rename, delete, or jump into
// editing the clue/answer words of any existing one. The behavior settings
// (time per word, hints, case sensitivity) live behind the gear icon
// instead - this screen is only about content.
export default function WordScrambleManager() {
